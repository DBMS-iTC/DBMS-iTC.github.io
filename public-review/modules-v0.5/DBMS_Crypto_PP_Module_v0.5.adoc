...
Dependencies: `FCS_CKM.6`; `FCS_RBG.1`.
...
|FCS_CKM.1/KEM
|`FCS_CKM.6`; `FCS_RBG.1`
|Included only for TOE-performed ML-KEM.KeyGen and resolved by the consumed key-destruction and RBG component set. Provisioned or externally generated ML-KEM key pairs do not trigger this component.
...
| FCS_CKM.1/KEM
| FCS_CKM.6; FCS_RBG.1
| Consumed `FCS_CKM.6`, `FCS_RBG.1`, and the selected seeding, primitive, failure, and self-test dependencies when the TOE performs ML-KEM.KeyGen
