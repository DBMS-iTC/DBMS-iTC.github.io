...
These modules and PP-Configurations are designed for use with the authoritative DBMS Base PP Version 2.0. Download link:../../cPP/cPP_DBMS_V2.0.pdf[the Version 2.0 cPP].
