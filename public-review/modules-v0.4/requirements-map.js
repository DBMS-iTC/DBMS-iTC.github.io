(() => {
  ...
  function renderConfigurationControl() {
    const choices = [{ id: 'all', label: 'All artifacts' }, ...data.configurations];
  ...
  function renderComposition() {
    ...
    elements.compositionMap.innerHTML = nodes.join('');
    if (configuration) {
      ...
      link.target = '_blank';
      link.rel = 'noopener';
      link.textContent = 'Open PP-Configuration';
      link.title = configuration.note;
      elements.compositionMap.append(link);
    }
  }
