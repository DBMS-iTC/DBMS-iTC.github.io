...
|A published requirement or Evaluation Activity needs a formal interpretation. For Version 2.0, use the document text; consult the link:/#_archives_and_previous_versions[archived Version 1.x documents and Technical Decisions] only for a cited Version 1.x document, and submit one question per request.
|===
