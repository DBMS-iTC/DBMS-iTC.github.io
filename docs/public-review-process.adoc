...
|A published requirement or Evaluation Activity needs a formal interpretation. For Version 2.0, use the document text; consult the link:/#technical-decisions[archived Technical Decisions] only for a cited Version 1.x document, and submit one question per request.
|===
