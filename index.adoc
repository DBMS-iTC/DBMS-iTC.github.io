...
+
Public Review Draft 1 of DBMS cPP and SD Version 2.0 was posted on 26 June 2026 for general public comment through 10 August 2026.
...
* link:/cPP/cPP_DBMS_V1.3.pdf[cPP v1.3]
* link:/SD/SD_DBMS_V1.1.pdf[SD v1.1]
* link:/public-review/v2.0/[DBMS Version 2.0 Public Review Draft 1]
* link:/public-review/modules-v0.4/[DBMS PP-Modules Version 0.4 Public Review Draft 1]
* {iTC-GitHub}[{iTC-shortname} GitHub repository]

== Technical Decisions (TDs)

Below are the published technical decisions. Files are hosted in the `/TD/` directory.
...
| link:TD/TD_DBMS_B_001.html[View HTML]
| link:TD/TD_DBMS_B_001.pdf[Download PDF]

| TD_DBMS_B_002
| Session Locking Mechanism Expansion
| link:TD/TD_DBMS_B_002.html[View HTML]
| link:TD/TD_DBMS_B_002.pdf[Download PDF]
|===
