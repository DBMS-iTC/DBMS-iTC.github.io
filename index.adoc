...
a|
[.release-label.module-label]#DRAFT MODULE REVIEW#
...
* link:#technical-decisions[*Archived Technical Decisions*] +
Legacy Version 1.x interpretations incorporated in Version 2.0
...
TD_DBMS_B_001 and TD_DBMS_B_002 were incorporated into the authoritative Version 2.0 documents. They are retained only as historical records for Version 1.x evaluations and do not apply separately to Version 2.0 evaluations.

.Archived Technical Decisions
[cols="1,3,3,1,1",options="header"]
|===
|TD ID |Title |Original scope and archive status |HTML |PDF

|TD_DBMS_B_001
|Update to Role Definitions and Security Attribute Management for Consistency
|DBMS cPP Version 1.3 only. Incorporated into Version 2.0; archived on 17 August 2026 and not separately applicable to Version 2.0.
|link:/TD/TD_DBMS_B_001.html[Archived HTML]
|link:/TD/TD_DBMS_B_001.pdf[Archived PDF]

|TD_DBMS_B_002
|Session Locking Mechanism Expansion
|DBMS cPP Version 1.3 and Supporting Document Version 1.1. Incorporated into Version 2.0; archived on 17 August 2026 and not separately applicable to Version 2.0.
|link:/TD/TD_DBMS_B_002.html[Archived HTML]
|link:/TD/TD_DBMS_B_002.pdf[Archived PDF]
|===
