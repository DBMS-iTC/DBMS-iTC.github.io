...
a|
[.release-label.archive-label]#ARCHIVED BASELINE#

*DBMS cPP Version 1.3 and Supporting Document Version 1.1*

Superseded by Version 2.0 on *17 August 2026*; retained for traceability.

link:#_archives_and_previous_versions[View archived documents]
